...
int main(){
    ...
    meugrafo.addNode("Node 1");
    meugrafo.addNode("Node 2");
    meugrafo.addNode("Node 3");
    meugrafo.addNode("Node 4");
    meugrafo.addNode("Node 5");

    meugrafo.addEdge("Node 1", "Node 4", 4);

    meugrafo.addEdge("Node 2", "Node 1", 7);
    meugrafo.addEdge("Node 2", "Node 3", 3);
    meugrafo.addEdge("Node 2", "Node 4", 12);

    meugrafo.addEdge("Node 3", "Node 2", 3);
    meugrafo.addEdge("Node 3", "Node 4", 5);
    meugrafo.addEdge("Node 3", "Node 5", 9);

    meugrafo.addEdge("Node 4", "Node 5", 2);

    meugrafo.addEdge("Node 5", "Node 1", 18);

    meugrafo.printAdjacencyList();

    std::getline(std::cin, partida);
    std::cout << "PROFUNDIDADE:\n";
    meugrafo.breadthFirstSearch(partida);
    std::cout << "LARGURA\n";
    meugrafo.breadthFirstSearch(partida);
